...
The frequency map file can be edited and labels from the antenna switch can be imported via antswitch-admin.php. User management is not explained further here. However, it is advisable to install a PAM module for Apache, which, for example, manages access to the "login" subfolder.
